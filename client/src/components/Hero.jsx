    ...
    <section className="text-white py-24 px-6">
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <h1 className="text-6xl font-bold leading-tight">
          AI Powered <span className="text-blue-500">Student Productivity</span> Platform
        </h1>

        <p className="text-zinc-400 text-lg mt-6 max-w-2xl mx-auto">
          Manage tasks, track study sessions, generate AI notes summaries,
          and boost productivity with smart tools designed for students.
        </p>
